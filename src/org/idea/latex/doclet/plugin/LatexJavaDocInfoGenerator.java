 ...
 */
public class LatexJavaDocInfoGenerator extends JavaDocInfoGenerator {

    private final Project project;
    private final PsiElement element;
    private final DocCommentProcessor processor;

    public LatexJavaDocInfoGenerator(Project project, PsiElement element, DocCommentProcessor processor) {
    ...
    public void generateCommonSection(StringBuilder buffer, PsiDocComment docComment) {
        ...
        System.out.println("generateCommonSection");
